      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-3xl w-full text-center">
          <div className="mb-12">
            ...
            <h1 className="text-sm font-bold uppercase tracking-widest mb-4">Page Not Found</h1>
          ...
          <div className="mt-12 pt-12 border-t border-black">
            <div className="grid grid-cols-3 gap-4 text-xs">
              <Link href="/about" className="text-neutral-600 hover:text-black transition-colors">About</Link>
              <Link href="/privacy" className="text-neutral-600 hover:text-black transition-colors">Privacy</Link>
              <Link href="/terms" className="text-neutral-600 hover:text-black transition-colors">Terms</Link>
            </div>
          </div>
        </div>
      </main>
